        ...
        <div className="max-w-[1400px] mx-auto px-6">
          <div className="grid lg:grid-cols-[2fr_3fr] gap-12 lg:gap-10 items-stretch">
            ...
            <div className="grid grid-cols-3 grid-rows-[1fr_1fr] gap-3 min-h-[400px] lg:h-full">
              ...
              <div className="row-span-1 relative rounded-2xl overflow-hidden">
                <Image src="/images/anos-trayectoria-v5.avif" alt="Trayectoria" fill sizes="(max-width: 768px) 33vw, 18vw" className="object-cover" style={{objectPosition: '35% 35%'}} />
                <div className="absolute inset-0 bg-black/40" />
                <div className="absolute bottom-0 left-0 right-0 p-4">
                ...
                >
                  <div className="relative w-full h-full">
                    <Image
                      ...
                      alt={sponsor.name}
                      fill
                      className={`object-contain object-center ${sponsor.name === 'Pepsi Music' ? '' : 'brightness-0 invert'} ${sponsor.name === 'Flux' ? 'brightness-200' : ''}`}
